return {
    ...
    humanize={
        preset="Very Subtle",enabled=true,strength=.05,timingMs=3,chordSpreadMs=2,durationVariation=.008,
        swingMs=.5,rubato=.03,handIndependence=.18,phraseExpression=.18,latencyMs=0,
        expressionCurve="Soft",seedMode="Auto",fixedSeed=12345,
    },
    ui={
        state="Full",floatingX=.84,floatingY=.72,performanceMode=false,songFilter="All",songSort="A-Z",
        showAdvancedHuman=true,showKeyPreview=true,
    },
