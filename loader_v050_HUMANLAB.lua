...
local PINNED_COMMIT="d6ac2a6ae30d2e4fbb987fce9ddb187722964a36"
local VERSION="0.5.0-HUMANLAB"
...
local cache,loading={},{}
local aliases={
    ["ConfigDefaults"]="ConfigDefaultsV050",
    ["UI/App"]="UI/AppMobileV050",
    ["Performance/Humanizer"]="Performance/HumanizerV050",
