local BOOTSTRAP_URL = "https://raw.githubusercontent.com/Johnatafgfdgf/Midi-to-qwerty-roblox-autoplayer/main/bootstrap.lua?v=0.3.2"
...
local chunk, err = loadstring(source, "=MIDIQWERTY/bootstrap.v032")
...
return bootstrap({owner="Johnatafgfdgf",repo="Midi-to-qwerty-roblox-autoplayer",branch="main",version="0.3.2"})
